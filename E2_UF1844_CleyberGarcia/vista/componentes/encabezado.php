...
<body>
	<header>
		<div class="container-fluid text-center">
			<div class="row">
				<div class="col">
					<img id="logo-imagen" src="./logos/Logo.png" alt="Logo" id="logo" width="120px"/>
				</div>
			</div>
			<div class="row"> 
				<div class="col">
					<nav class="navbar navbar-expand-lg bg-body-tertiary">
						<div class="container-fluid">
							...
							<ul class="navbar-nav me-auto mb-2 mb-lg-0 efecto-hover">
								<li class="nav-item">
								<a class="nav-link active" aria-current="page" href="#">Get the Look</a>
								</li>
								<li class="nav-item">
								...
								<li class="nav-item">
								<a class="nav-link" href="#">Segunda mano</a>
								</li>
							</ul>
